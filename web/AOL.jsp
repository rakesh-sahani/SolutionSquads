...
<html>
    ...
    <head>
        ...
        %>
        <meta http-equiv="keywords" name="keywords" content="AOL" />
        <meta http-equiv="description" name="description" content="AOL" />
        <%}
        ...
        <div id="body">
            <div id="content">
                ...
                <div id="section">
                    ...
                    <h2>Support For AOL</h2>
                    <img src="images/aol.jpg" width="580px" alt="">
                    <p>
                        <%=scontent%>  
                    </p>
                </div>
